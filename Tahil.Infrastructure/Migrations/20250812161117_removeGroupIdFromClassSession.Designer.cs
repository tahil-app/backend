...
namespace Tahil.Infrastructure.Migrations
{
    ...
    [Migration("20250812161117_removeGroupIdFromClassSession")]
    partial class removeGroupIdFromClassSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tahil.Domain.Entities.ClassSession", b =>
                {
                    ...
                    b.Property<int?>("OverrideTeacherId")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Tahil.Domain.Entities.ClassSession", b =>
                {
                    b.HasOne("Tahil.Domain.Entities.Room", "OverrideRoom")
                        .WithMany("Sessions")
                        .HasForeignKey("OverrideRoomId");

                    b.HasOne("Tahil.Domain.Entities.Teacher", "OverrideTeacher")
                        .WithMany("Sessions")
                        .HasForeignKey("OverrideTeacherId");
                    ...
                    b.Navigation("OverrideRoom");

                    b.Navigation("OverrideTeacher");
